...
function OrderManagement() {
  ...
  return (
    ...
    <NavBar/>
    <div className="min-h-screen bg-gradient-to-br bg-cover bg-center" style={{backgroundImage: 'url("../images/bg.jpg")', backgroundAttachment: 'fixed'}}>
          ...
          <div className="flex flex-wrap -mx-2">
            <div className="w-full lg:w-1/2 px-2 mb-4 lg:mb-0">
              ...
              <div className="flex flex-wrap -mx-2">
                ...
                <div className="w-full lg:w-1/2 px-2 mb-2">
                    <input type="number" name="quantity" placeholder="Quantity" value={newOrder.quantity || ''} onChange={handleInputChange} className="px-2 py-1 rounded-md input" />
                </div> 
